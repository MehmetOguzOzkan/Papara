...
{
    /// <inheritdoc />
    public partial class MigrationForMsSqlV10 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WalletCurrency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false, defaultValue: "TRY"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoyaltyPointsRatio = table.Column<decimal>(type: "decimal(3,2)", precision: 3, scale: 2, nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCategories_Id_ProductId_CategoryId",
                table: "ProductCategories",
                columns: new[] { "Id", "ProductId", "CategoryId" });
